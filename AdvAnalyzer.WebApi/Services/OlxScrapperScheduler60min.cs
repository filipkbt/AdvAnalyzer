...
{
    public class OlxScrapperScheduler60min : BackgroundService
    {
        private readonly IServiceScopeFactory _serviceScopeFactory;
        private readonly ILogger _logger;
        private readonly IEmailSender _emailSender;

        public OlxScrapperScheduler60min(IServiceScopeFactory serviceScopeFactory, ILogger<OlxScrapperScheduler60min> logger, IServiceProvider serviceProvider)
        {
